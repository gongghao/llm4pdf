...
import fitz
from PPStructureV3.recovery.recovery_to_doc import sorted_layout_boxes
...
engine = PPStructureV3(table=False, ocr=False, show_log=True, text_recognition_model_name="en_PP-OCRv4_mobile_rec")
